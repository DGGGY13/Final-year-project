...
set(_exported_dependencies "ament_cmake;rclcpp;rclcpp_action;tf2_geometry_msgs;tf2_ros;moveit_core;moveit_ros_planning_interface;tf2_geometry_msgs;moveit_ros_planning;pluginlib;Eigen3;Boost;control_msgs;moveit_servo;moveit_task_constructor_core")

find_package(ament_cmake_libraries QUIET REQUIRED)

# find_package() all dependencies
# and append their DEFINITIONS INCLUDE_DIRS, LIBRARIES, and LINK_FLAGS
# variables to realtime_servo_DEFINITIONS, realtime_servo_INCLUDE_DIRS,
# realtime_servo_LIBRARIES, and realtime_servo_LINK_FLAGS.
# Additionally collect the direct dependency names in
# realtime_servo_DEPENDENCIES as well as the recursive dependency names
# in realtime_servo_RECURSIVE_DEPENDENCIES.
if(NOT _exported_dependencies STREQUAL "")
  find_package(ament_cmake_core QUIET REQUIRED)
  set(realtime_servo_DEPENDENCIES ${_exported_dependencies})
  set(realtime_servo_RECURSIVE_DEPENDENCIES ${_exported_dependencies})
  set(_libraries)
  foreach(_dep ${_exported_dependencies})
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(realtime_servo_INCLUDE_DIRS "${_include_dirs}")
          endif()
    ...
    if(NOT use_modern_cmake)
      if(${_dep}_DEFINITIONS)
        list_append_unique(realtime_servo_DEFINITIONS "${${_dep}_DEFINITIONS}")
      endif()
      if(${_dep}_INCLUDE_DIRS)
        list_append_unique(realtime_servo_INCLUDE_DIRS "${${_dep}_INCLUDE_DIRS}")
      endif()
      if(${_dep}_LIBRARIES)
        list(APPEND _libraries "${${_dep}_LIBRARIES}")
      endif()
      if(${_dep}_LINK_FLAGS)
        list_append_unique(realtime_servo_LINK_FLAGS "${${_dep}_LINK_FLAGS}")
      endif()
      if(${_dep}_RECURSIVE_DEPENDENCIES)
        list_append_unique(realtime_servo_RECURSIVE_DEPENDENCIES "${${_dep}_RECURSIVE_DEPENDENCIES}")
      endif()
    endif()
    if(_libraries)
      ament_libraries_deduplicate(_libraries "${_libraries}")
      list(APPEND realtime_servo_LIBRARIES "${_libraries}")
    endif()
  endforeach()
endif()
